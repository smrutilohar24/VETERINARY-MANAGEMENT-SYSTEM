...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update_vaccination"])) {
    ...
    echo "<p>Vaccination Date: $vacc_date</p>";
    echo "<p>Vaccination Time: $vacc_time</p>";
...
<form method="post" action="vaccination.php">
    ...
    <input type="date" name="vacc_date" value="<?php echo $appoint['vacc_date']; ?>" required><br>
    <label for="vacc_time">Vaccination Time:</label>
    <input type="time" name="vacc_time" value="<?php echo $appoint['vacc_time']; ?>" required><br>
    <input type="submit" name="update_vaccination" value="Update Vaccination">
</form>
</div>
</body>
</html>