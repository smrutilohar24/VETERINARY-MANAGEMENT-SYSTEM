...
$sql = "SELECT pet_name, owner_name, medication, doctor_name FROM prescript";
...
<head>
    ...
    <title>Manage Prescription - Veterinary Management System</title>
    ...
    <div class="container">
        <div class="admin-content">
            ...
            <table border="1" cellspacing="50">
                ...
                <tbody>
                   <tr>
                    <?php foreach ($prescript as $prescription): ?>
                        <td><?php echo $prescription['pet_name']; ?></td>
                        <td><?php echo $prescription['owner_name']; ?></td>
